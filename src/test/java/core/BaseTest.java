...
public class BaseTest {
    ...
    public void beforeTests() {
        driver = startBrowser(BrowserTypes.FIREFOX);  // Can be changed for other browser types
    ...
    protected static WebDriver startBrowser(BrowserTypes browserType) {
        switch (browserType) {
            case CHROME:
                WebDriverManager.chromedriver().setup();  // Automatically detects the correct driver version
